...
1. Instalar json-server con el comando `npm install -g json-server` desde tu terminal con privilegios de administrador.
2. Navegar al directorio <.../src/db> de nuestro proyecto.
...
* `dev` - Ejecuta la aplicación en modo desarrollo en el puerto [3080](http://localhost:3080).
